function varargout = sampsamp2(varargin)
% SAMPSAMP2 M-file for sampsamp2.fig
%      SAMPSAMP2, by itself, creates a new SAMPSAMP2 or raises the existing
%      singleton*.
%
%      H = SAMPSAMP2 returns the handle to a new SAMPSAMP2 or the handle to
%      the existing singleton*flyfly
%
%      SAMPSAMP2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SAMPSAMP2.M with the given input arguments.
%
%      SAMPSAMP2('Property','Value',...) creates a new SAMPSAMP2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before sampsamp2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to sampsamp2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help sampsamp2

% Last Modified by GUIDE v2.5 17-Mar-2020 08:30:38

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @sampsamp2_OpeningFcn, ...
                   'gui_OutputFcn',  @sampsamp2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before sampsamp2 is made visible.
function sampsamp2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to sampsamp2 (see VARARGIN)

% Choose default command line output for sampsamp2
handles.output = hObject;

% UIWAIT makes sampsamp2 wait for user response (see UIRESUME)
...
function varargout = sampsamp2_OutputFcn(hObject, eventdata, handles) 
% varargout  cell array for returning output args (see VARARGOUT);
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
